...
async def genv2keyto(interaction: discord.Interaction, users: str, duration: str = "lifetime", amount: int = 1):
    ...
    for member, generated_keys in results:
        ...
        try:
            ...
            dm_results.append(f"✅ {member.mention}")
